...
=============================================================================
    ...
    if ( params.database_path ){
        ...
        gemc_wolf_production_input = tempAndDensity.join(convergenceChannelFlattened).join(build_GEMC_system_Calibrate.out.convergence).combine(solvent_xml_channel)
